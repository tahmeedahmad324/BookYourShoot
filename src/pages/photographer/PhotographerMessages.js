...
const PhotographerMessages = () => {
  ...
  const getClientName = (conversation) => {
    const client = conversation.other_user;
    return client?.name || conversation.participants?.find(p => p.role === 'CLIENT')?.name || 'Client';
  };
    ...
    <div className="container py-4">
        ...
        <div className="col-12">
          <div className="d-flex align-items-center justify-content-between gradient-header rounded-3 p-4">
            <div>
              ...
              <p className="mb-0 text-muted">Chat with clients and respond to inquiries</p>
            </div>
      ...
      {!loading && conversations.length === 0 && !error && (
        <div className="text-center py-5">
          ...
          <p className="text-muted mb-4">When clients send inquiries, they will appear here</p>
        </div>
      )}
        ...
        <div className="row">
          <div className="col-lg-8 mx-auto">
            <div className="card border-0 shadow-sm">
              <div className="list-group list-group-flush">
                {conversations.map((conversation) => (
                  <Link
                    key={conversation.id}
                    to={`/photographer/chat/${conversation.id}`}
                    ...
                    <div className="d-flex align-items-start">
                      ...
                      <div className="flex-grow-1" style={{ minWidth: 0 }}>
                        <div className="d-flex justify-content-between align-items-start mb-1">
                          <h6 className="mb-0 fw-bold">{getClientName(conversation)}</h6>
            ...
            <div className="alert alert-info mt-4" role="alert">
              <strong>💡 Tip:</strong> INQUIRY conversations are limited to 15 messages. Encourage clients to create bookings to unlock unlimited messaging!
            </div>
          </div>
        </div>
      )}
